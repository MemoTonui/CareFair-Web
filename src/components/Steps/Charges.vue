  ...
  <div>
    <div>
      ...
      >
        ...
        <li class="flex items-center text-white p-2 bg-light-green">
          <span
            class="flex items-center justify-center w-5 h-5 mr-2 text-xs border border-gray-500 rounded-full shrink-0 dark:border-gray-400"
          >
            3
    ...
    <div class="m-10">
      <div class="mt-5">
        <h4 class="text-2xl font-bold text-black md:text-2xl mt-1 mb-2 pb-1">
          Hourly Charges
        </h4>

        <p class="text-sm">Let us know how much you would like to charge per hour</p>
      </div>
      <form class="my-10">
        <div class="mb-2">
          <TextBox
